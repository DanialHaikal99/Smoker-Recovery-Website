      ...
      <div class="container" style="border: 1px solid white;">
          ...
          <h3 class="cta-title" style="color:white;">Occupation Info</h3>
           ...
           <div class="col-lg-3 cta-btn-container text-center">
            <a class="cta-btn align-middle" href="profileinfoeditmedicalprac2.php" style="margin-right:90px">Edit Info</a>
          </div>
          <hr style="border-top: 1px solid white;">
        <div class="row" data-aos="zoom-in">
          <div class="col-lg-9 text-center text-lg-left">

              <h5 class="cta-text"><b> Your Qualification:</b><br/><br/><?php echo  $medicalprac_qualification; ?></h5><br/> 
              <h5 class="cta-text"><b> Your Year Of Experience In The Medical Field:</b><br/><br/><?php echo  $medicalprac_yearofex; ?></h5><br/>
              <h5 class="cta-text"><b> Your Reason Of Joining The System:</b><br/><br/><?php echo  $medicalprac_reason; ?></h5><br/>
          </div>
        </div>
