   ...
   <header id="header" class="header-transparent">
    ...
    <?php
          if(isset($_POST['submit'])) {
            ...
            $sql = "INSERT INTO wings_details (details_username, details_name, details_address, details_phone, details_email , details_type)VALUES ('$details_username','$details_name','$details_address','$details_phone','$details_email','socialsupp')";		
     ...
     <?php
          if(isset($_POST['submit'])) {
            ...
            $sql = "INSERT INTO wings_user (user_username, user_password , user_type)VALUES ('$user_username','$user_password','socialsupp')";		
   ...
   <!-- ======= Call To Action Section ======= -->
    <section id="call-to-action">
      <div class="container" style="border: 1px solid white;">
          ...
          <h3 class="cta-title" style="color:white;">Add Social Supporter</h3>
          </div>
          <form name="adduser" enctype="multipart/form-data" action="addsocialsupp.php" method="post">
