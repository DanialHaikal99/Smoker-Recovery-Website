  ...
  <header id="header" class="header-transparent">
    <div class="container">
      ...
      <div id="logo" class="pull-left">
        <a href="indexsmokerphp"><img src="assets/img/wings2.png"  alt=""></a>
   ...
   <!-- ======= Call To Action Section ======= -->
    <section id="call-to-action">
      <div class="container" style="border: 1px solid white;">
          ...
          <h3 class="cta-title" style="color:white;">Login Info</h3>
          </div>
           <div class="col-lg-3 cta-btn-container text-center">
            <a class="cta-btn align-center" href="profileinfoeditsmoker2.php" style="margin-right:90px">Edit Info</a>
             
          </div>
          <hr style="border-top: 1px solid white;">
        <div class="row" data-aos="zoom-in">
          <div class="col-lg-9 text-center text-lg-left">
              <h5 class="cta-text"><b>Password :</b><br/><br/><?php echo  $user_password; ?></h5><br/>
