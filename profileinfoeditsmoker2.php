...
<?php  	
    ...
    <?php
     ...
     <!--<script>
            ...
            alert("You will be directed to home page to save your request to change your username, Please login again with your new username.");
              }
	      </script>-->
...
<form name="editprofile2" enctype="multipart/form-data" action="profileinfoeditsmoker2.php" method="post">
     ...
     <!--<div class="cta-btn align-center" style="margin-leftt:30px;background-color:black;"><a href="logout.php" onclick="myFunctiona()" style="color:white;">Save</a>
          </div>-->
