      ...
      <div class="container" style="border: 1px solid white;">
          ...
          <h3 class="cta-title" style="color:white;">Medication History</h3>
           ...
           <div class="col-lg-3 cta-btn-container text-center">
             <a class="cta-btn align-center" href="editsmokermedicationhistorysmoker.php" style="margin-right:90px">Edit Info</a>
             
          </div>
          <hr style="border-top: 1px solid white;">
        <div class="row" data-aos="zoom-in">
          <div class="col-lg-9 text-center text-lg-left">
               <h5 class="cta-text"><b>Your Medication History</b><br/><br/><?php echo  $MedicationHisDesc; ?><br/></h5>
