   ...
   <!-- ======= Call To Action Section ======= -->
    <section id="call-to-action">
      <div class="container" style="border: 1px solid white;">
          ...
          <h3 class="cta-title" style="color:white;">Schedule</h3>
              <p class="cta-text" style="color:yellow;"><b>Alert! Please note that this schedule is prepared by a medical professional to you after reviewing your smoking history</b></p>
              <a class="cta-btn align-middle" style="background-color:black;margin-right:100px;" href="editschedulemedicalprac.php">Submit</a>
          </div>
        ...
        <div class="row" data-aos="zoom-in">
          <div class="col-lg-9 text-center text-lg-left">
              ...
              <h5 class="cta-text"><b>Edit Schedule</b><br/><br/><textarea  style="width:600px;height:200px;" class="form-control" name="name" style="width:330px;border-color:black;">Monday - 1 cigarette at night    Tuesday - No cigarette   Wednesday - 1 cigarette at night   Thursday - No cigarette   Friday - 1 cigarette at night   Saturday - No cigarette   Sunday - 1 cigarette at night</textarea><br/></h5>
