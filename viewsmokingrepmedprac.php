...
<body>
  ...
  <header id="header" class="header-transparent">
    ...
    <?php  	
					...
					$sql="select * from Wings_SmokingRep where SmokingRepUsername='$code'";
					$resu=$conn->query($sql);
					if(empty(mysqli_num_rows($resu))){
						...
						while($row=mysqli_fetch_assoc($resu)){
							...
							$SmokingRepName	= $row["SmokingRepName"];	
   ...
   <!-- ======= Call To Action Section ======= -->
    <section id="call-to-action">
      <div class="container" style="border: 1px solid white;">
          ...
          <h3 class="cta-title" style="color:white;">Smoking Report</h3>
          </div>
 <div class="col-lg-3 cta-btn-container text-center">
        ...
        <div class="row" data-aos="zoom-in">
          <div class="col-lg-9 text-center text-lg-left">
            <h5 class="cta-text"><b>Username :</b><br/><br/><?php echo $SmokingRepUsername; ?></h5><br/>
              <h5 class="cta-text"><b>Name :</b><br/><br/><?php echo  $SmokingRepName; ?></h5><br/>
              <h5 class="cta-text"><b>Smoking Report :</b><br/><br/><?php echo  $SmokingRepDesc; ?></h5><br/>
              
              <p class="cta-text" style="color:cyan;">Please note that if the smoking report contains [Please update your smoking report] template, then that means that the smoker has not updated his smoking report yet, and the medical practitioner must ignore this smoker until he updates his smoking report.</p>
            </div>
