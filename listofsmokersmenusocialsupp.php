      ...
      <div class="container" style="border: 2px dashed white;">
        <div class="row" data-aos="zoom-in">
          ...
          <div class="col-lg-3 cta-btn-container text-center">
            <a class="cta-btn align-middle" href="viewsmokersocialsupp.php?code=<?php echo $row['user_username'];?>">View Details</a>
               <a class="cta-btn align-middle" href="viewhistorysocialsupp.php?code=<?php echo $row['user_username'];?>">Smoking History</a>
               <a class="cta-btn align-middle" href="viewreportsocialsupp.php?code=<?php echo $row['user_username'];?>">Smoking Report</a>
          </div>
