      ...
      <div class="container" style="border: 1px solid white;">
        ...
        <div class="row" data-aos="zoom-in">
          <div class="col-lg-9 text-center text-lg-left">
              ...
              <h5 class="cta-text"><b>Add Schedule</b><br/><br/><textarea  style="width:600px;height:200px;" class="form-control" name="name" style="width:330px;border-color:black;"></textarea><br/></h5>
