      ...
      <div class="container" style="border: 1px solid white;">
          ...
          <h3 class="cta-title" style="color:white;">Smoking Report</h3>
           ...
           <div class="col-lg-3 cta-btn-container text-center">
            <a class="cta-btn align-center" href="editsmokerssmokingreportsmoker.php" style="margin-right:90px">Edit Info</a>
             
          </div>
          <hr style="border-top: 1px solid white;">
        <div class="row" data-aos="zoom-in">
          <div class="col-lg-9 text-center text-lg-left">
              <h5 class="cta-text"><b>Your Smoking Report</b><br/><br/><?php echo  $SmokingRepDesc; ?><br/><br/></h5>
