...
<body>
  ...
  <header id="header" class="header-transparent">
    ...
    /*
		...
		$code = $_REQUEST['code'];
		$result = mysqli_query($conn, "select * from wings_user WHERE user_id = '$code'");
    ...
    <?php  	
					...
					$sql="select * from wings_details where details_id='$code'";
					$resu=$conn->query($sql);
   ...
   <!-- ======= Call To Action Section ======= -->
    <section id="call-to-action">
      <div class="container" style="border: 1px solid white;">
          ...
          <h3 class="cta-title" style="color:white;">Report</h3>
              <a class="cta-btn align-middle" style="background-color:black;margin-right:100px;" href="addreportmedicalprac.php">Add Report</a>
          </div>
        ...
        <div class="row" data-aos="zoom-in">
          <div class="col-lg-9 text-center text-lg-left">
              <h5 class="cta-text"><b>Smoker's Smoking Report</b><br/><br/>I took two puffs a day for the majority of the scheduled days. But there was one day at Friday i took 5 puffs.<br/><br/></h5>
           <hr style="border-top: 1px solid white;width:1110px;">
               <h5 class="cta-text"><b>The Smoker's Report</b><br/><br/>Hello This is Dr. Kannan Krishnan, im a medical practitioner. You are doing good for the most part but you have to stop the excessive smoking on some days. But you're on a good track !<br/></h5>
           
            <a class="cta-btn align-middle" style="background-color:black;margin-right:100px;" href="editreportmedicalprac.php">Edit Report</a>
