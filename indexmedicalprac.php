...
<body>
  ...
  <header id="header" class="header-transparent">
    <div class="container">
      ...
      <nav id="nav-menu-container">
        <ul class="nav-menu">
          <li class="menu-active"><a href="indexmedicalprac.php">Home</a></li>
  ...
  <section id="hero">
    <div class="hero-container" data-aos="zoom-in" data-aos-delay="100">
      ...
      <h2>Lets get started. Click learn more to finish your register in the system.</h2>
      ...
      <div class="container" data-aos="fade-up">
        <div class="row about-container">
          ...
          <div class="col-lg-6 content order-lg-1 order-2">
            <h2 class="title">Steps to finish your register as a medical practitioner if you are new to the system</h2>
            <p>
              There a few things you have to fill before being a part of the system <?php echo $_SESSION['user_username'] ?>
            </p>
