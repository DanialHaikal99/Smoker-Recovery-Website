  ...
  <?php  	
     ...
     <?php
          ...
          if(isset($_POST['submit'])) {
              if(isset($_POST['edit'])){ 
             $SmokingHisID	= $_POST['edit'];
             $SmokingHisDesc		= $_POST['smoke'];
              
              
            $sql="select * from Wings_SmokingHis where SmokingHisID='$SmokingHisID'";
		$resul=$conn->query($sql);
              
					$queryu ="update Wings_SmokingHis set SmokingHisDesc=' $SmokingHisDesc' where SmokingHisID = '$SmokingHisID' ";
   ...
   <!-- ======= Call To Action Section ======= -->
    <section id="call-to-action">
      <div class="container" style="border: 1px solid white;">
          ...
          <h3 class="cta-title" style="color:white;">Edit Smoking History</h3>
          </div>
        ...
        <div class="row" data-aos="zoom-in">
          <div class="col-lg-9 text-center text-lg-left">
              <form name="editsmokinghis" enctype="multipart/form-data" action="editsmokersmokinghistorysmoker.php" method="post">
              <h5 class="cta-text"><b>Your Smoking History</b><br/><br/><textarea  type="name" style="width:600px;height:200px;" class="form-control"  name="smoke" style="width:330px;border-color:black;"><?php echo  $SmokingHisDesc; ?></textarea></h5><br/>
           
            <button class="cta-btn align-center" name="submit" type="submit"  style="margin-right:100px;background-color:black;">Submit</button>
        <input type="hidden" name="edit" value="<?php echo $SmokingHisID; ?>" style="color:black;">
                  <input type="hidden" name="username" value="<?php echo $SmokingHisUsername; ?>" style="color:black;">
              </form>
