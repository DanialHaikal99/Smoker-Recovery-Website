    ...
    <section id="call-to-action">
      <div class="container" style="border: 1px solid white;">
        ...
        <div class="row" data-aos="zoom-in">
          <div class="col-lg-9 text-center text-lg-left">
              <h5 class="cta-text"><br/><b>Username : </b><br/><br/><?php echo  $SmokingRepUsername; ?><br/><br/><b>Smoker's Name : </b><br/><br/><?php echo  $SmokingRepName; ?><br/><br/><b>Smoker's Smoking Report : </b><br/><br/><?php echo  $SmokingRepDesc; ?><br/><br/></h5>
              <p class="cta-text" style="color:cyan;">Please note that if the smoking report contains [Please update your smoking report] template, then that means that the smoker has not updated his smoking report yet, and it is recommended for the social supporter to ignore this smoker until he updates his smoking report.</p>
            </div>
          </div>
      </div>
