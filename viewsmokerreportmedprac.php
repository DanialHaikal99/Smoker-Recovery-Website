...
<body>
  ...
  <header id="header" class="header-transparent">
    ...
    <?php  	
					...
					$sql="select * from Wings_SmokerRep where SmokerRepUsername='$code'";
					$resu=$conn->query($sql);
					if(empty(mysqli_num_rows($resu))){
						echo "session lost ERROR : $sql". $conn->error;
					}else{
						while($row=mysqli_fetch_assoc($resu)){
							$SmokerRepID		= $row["SmokerRepID"];
                            $SmokerRepUsername	= $row["SmokerRepUsername"];
							$SmokerRepName	= $row["SmokerRepName"];	
							$SmokerRepDesc		= $row["SmokerRepDesc"];					
						}
					}
          ?>
     ...
     <?php
          ...
          if(isset($_POST['submit'])) {
              if(isset($_POST['edit'])){ 
             $SmokerRepID	= $_POST['edit'];
             $SmokerRepDesc		= $_POST['smoke'];
              
              
            $sql="select * from Wings_SmokerRep where SmokerRepID='$SmokerRepID'";
		$resul=$conn->query($sql);
              
					$queryu ="update Wings_SmokerRep set SmokerRepDesc=' $SmokerRepDesc' where SmokerRepID = '$SmokerRepID' ";
   ...
   <!-- ======= Call To Action Section ======= -->
    <section id="call-to-action">
      <div class="container" style="border: 1px solid white;">
          ...
          <h3 class="cta-title" style="color:white;">Smoker Report</h3>
          </div>
        ...
        <div class="row" data-aos="zoom-in">
          ...
          <div class="col-lg-9 text-center text-lg-left">
               <h5 class="cta-text" style="color:white;"><b>View Smoker Report</b></h5><br/>
              
            <h5 class="cta-text"><b>Username :</b><br/><br/><?php echo $SmokerRepUsername; ?></h5><br/>
              <h5 class="cta-text"><b>Name :</b><br/><br/><?php echo  $SmokerRepName; ?></h5><br/>
              <h5 class="cta-text"><b>Smoker Report :</b><br/><br/><?php echo  $SmokerRepDesc; ?></h5><br/>
             ...
             <hr style="border-top: 1px solid white;">
          <div class="col-lg-9 text-center text-lg-left">
               <h5 class="cta-text" style="color:white;"><b>Edit Smoker Report</b></h5><br/>
              
           <form name="editsmokerreport" enctype="multipart/form-data" action="viewsmokerreportmedprac.php?code=<?php echo $code;?>" method="post">
              <h5 class="cta-text"><b>Smoker's Report</b><br/><br/><textarea  type="name" style="width:600px;height:200px;" class="form-control"  name="smoke" style="width:330px;border-color:black;"><?php echo  $SmokerRepDesc; ?></textarea></h5><br/>
           
            <button class="cta-btn align-center" name="submit" type="submit"  style="margin-right:100px;background-color:black;">Submit</button>
        <input type="hidden" name="edit" value="<?php echo $SmokerRepID; ?>" style="color:black;">
              </form>
