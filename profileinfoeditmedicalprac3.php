...
<?php  	
    ...
    <!-- <script>
            ...
            alert("You will be directed to home page to save your request to change your username, Please login again with your new username or password.");
              }
	      </script>-->
    ...
    <section id="call-to-action">
      <div class="container" style="border: 1px solid white;">
          ...
          <h3 class="cta-title" style="color:white;">Personal Info</h3>
              <!--<p class="cta-text" style="color:yellow;"><b>Warning! - Clicking the browser back button after changing the info without clicking save and login again will result in problems. Please click the save button after clicking the submit button to logout of the system and please click yes to redirect to the home page to prevent any login problems in the current session</b>.</p>-->
          </div>
<form name="editprofile2" enctype="multipart/form-data" action="profileinfoeditmedicalprac3.php" method="post">
