   ...
   <!-- ======= Call To Action Section ======= -->
    <section id="call-to-action">
      <div class="container" style="border: 1px solid white;">
          ...
          <h3 class="cta-title" style="color:white;">Edit Report</h3>
          </div>
        ...
        <div class="row" data-aos="zoom-in">
          <div class="col-lg-9 text-center text-lg-left">
              <h5 class="cta-text"><b>The Smoker's Report</b><br/><br/><textarea  style="width:600px;height:200px;" class="form-control" name="name" style="width:330px;border-color:black;">Hello This is Dr. Kannan Krishnan, im a medical practitioner. You are doing good for the most part but you have to stop the excessive smoking on some days. But you're on a good track !</textarea><br/></h5>
           
            <a class="cta-btn align-middle" style="background-color:black;margin-right:100px;" href="editreportmedicalprac.php">Submit</a>
