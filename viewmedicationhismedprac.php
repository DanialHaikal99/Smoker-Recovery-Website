...
<body>
  ...
  <header id="header" class="header-transparent">
    ...
    <?php  	
					...
					$sql="select * from Wings_MedicationHis where MedicationHisUsername='$code'";
					$resu=$conn->query($sql);
					if(empty(mysqli_num_rows($resu))){
						...
						while($row=mysqli_fetch_assoc($resu)){
							...
							$MedicationHisName	= $row["MedicationHisName"];	
   ...
   <!-- ======= Call To Action Section ======= -->
    <section id="call-to-action">
      <div class="container" style="border: 1px solid white;">
          ...
          <h3 class="cta-title" style="color:white;">Medication History</h3>
          </div>
 <div class="col-lg-3 cta-btn-container text-center">
        ...
        <div class="row" data-aos="zoom-in">
          <div class="col-lg-9 text-center text-lg-left">
            <h5 class="cta-text"><b>Username :</b><br/><br/><?php echo $MedicationHisUsername; ?></h5><br/>
              <h5 class="cta-text"><b>Name :</b><br/><br/><?php echo  $MedicationHisName; ?></h5><br/>
              <h5 class="cta-text"><b>Medication History :</b><br/><br/><?php echo  $MedicationHisDesc; ?></h5><br/>
              
              <p class="cta-text" style="color:cyan;">Please note that if the medication history contains [Please update your medication history] template, then that means that the smoker has not updated his medication history yet, and the medical practitioner must ignore this smoker until he updates his medication history.</p>
            </div>
