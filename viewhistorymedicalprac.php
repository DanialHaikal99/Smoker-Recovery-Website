   ...
   <!-- ======= Call To Action Section ======= -->
    <section id="call-to-action">
      <div class="container" style="border: 1px solid white;">
          ...
          <h3 class="cta-title" style="color:white;">History</h3>
          </div>
        ...
        <div class="row" data-aos="zoom-in">
          <div class="col-lg-9 text-center text-lg-left">
              <h5 class="cta-text"><b>Smoking History</b><br/><br/>Started smoking in highscholl when i was 13-years old(now im 56)<br/><br/>I usually smoke 1 pack of cigarettes for a week.<br/><br/>I dont inhale the smoke, i only exhale the smoke<br/></h5>
           <hr style="border-top: 1px solid white;width:1110px;">
              <h5 class="cta-text"><b>Medication History</b><br/><br/>I only have asthma so the only medication i've taken and im taking is an inhaler.<br/><br/></h5>
