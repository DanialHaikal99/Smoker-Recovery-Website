    ...
    <section id="call-to-action">
      <div class="container" style="border: 1px solid white;">
        ...
        <div class="row" data-aos="zoom-in">
          <div class="col-lg-9 text-center text-lg-left">
                            <h5 class="cta-text"><br/><b>Username : </b><br/><br/><?php echo  $SmokingHisUsername; ?><br/><br/><br/><b>Smoker's Name :</b> <br/><br/><?php echo  $SmokingHisName; ?><br/><br/><br/><b>Smoker's Smoking History : </b><br/><br/><?php echo  $SmokingHisDesc; ?><br/><br/></h5>
