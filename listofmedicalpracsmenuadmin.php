    ...
    <section id="call-to-action">
      <div class="container">
        <div class="row" data-aos="zoom-in">
            <h3 class="cta-title">List Of Medical Practitioners In The System</h3>
...
<h5 class="section-title" style="color:white;">From Recent To Oldest</h5>
     ...
     <?php
                 ...
                 $sql = "select * from wings_user where user_type = 'medicalprac' order by user_id desc";
      ...
      <div class="container" style="border: 2px dashed white;">
        <div class="row" data-aos="zoom-in">
          ...
          <div class="col-lg-3 cta-btn-container text-center">
            <a class="cta-btn align-middle" href="viewmedicalpracadmin.php?code=<?php echo $row['user_username'];?> ">View Details</a>
              <a class="cta-btn align-middle" style="background-color:red;" href="deletemed.php?del=<?php echo $row['user_username'];?>  ">Delete User</a>
          </div>
